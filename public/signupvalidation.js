    ...
    $flag=1;
      $("#firstName").focusout(function(){
        ...
        if($(this).val()==''){
            ...
            $(this).css("border-color", "#FF0000");
              $('#submit').attr('disabled',true);
               $("#error_name").text("*You have to enter minimum 3 characters");
          }
          else
          {
        ...
        if($(this).val()==''){
            $(this).css("border-color", "#FF0000");
              ...
              $(this).css("border-color", "#FF0000");
               $('#submit').attr('disabled',true);
               $("#error_lname").text("*You have to enter minimum 3 characters");
          }
          else
          {
            $(this).css("border-color", "#2eb82e");
       ...
       $("#phone").focusout(function(){
        ...
        if($(this).val()==""){
          ...
          $("#userName").focusout(function(){
            if($(this).val()==''){
                $(this).css("border-color", "#FF0000");
                  $('#submit').attr('disabled',true);
                  $("#error_username").text("* You have to enter your User name!");
              }
               else if($(this).val().length<6){
    
                  $(this).css("border-color", "#FF0000");
                   $('#submit').attr('disabled',true);
                   $("#error_username").text("*Username must be 6 characters");
              }
              else
              {
                $(this).css("border-color", "#2eb82e");
        ...
        if(pass==''){
          ...
          else if($("#password").val().length < 8)
          {
            $(this).css("border-color","#FF0000");
              $('#submit').attr('disabled',true);
              $("#error_password").text("*Password must be 8 characters");
          }
          else if (strength < 1 )
          {
             $(this).css("border-color","#FF0000");
             $('#submit').attr('disabled',true);
             $("#error_password").text("*please use letters,symbols and numbers");   
          }
          else
          {  
                  $(this).css({"border-color":"#2eb82e"});
      ...
      $("#submit").click(function() {
        ...
        if ($("#firstName").val() == '') {
         ...
         if ($("#userName").val() == '') {
            ...
            $("#userName").css("border-color", "#FF0000");
            $("#error_username").text("*You have to enter minimum 6 characters");
            passedValidation = false;
         }
         else
         {
